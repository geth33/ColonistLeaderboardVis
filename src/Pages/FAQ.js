  ...
  return (
    <div className='faq' style={{background: '#2b77c6'}}>
      ...
      <div>
        ...
        <QuestionDropdown question={"Why can't I see all of my data for the entire season?"} answer={"Every 12 hours, I take a snapshot of the top 200 players in both Base and 1v1. I simply don't have space to store everyone's entire season."}/>
